...
io.popen("cd library && wget https://raw.githubusercontent.com/SIRIATEAM/SIRI/main/library/redis.lua") 
...
if hash or SudoBot(msg) or DevSIRIAW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSIRIAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevSIRIAW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevSIRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSIRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSIRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevSIRIAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
--------------------------------------------------------------------------------------------------------------
function SourceSIRIA(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."SIRIA1:List:Filter"..sl)
...
if not DevSIRIAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevSIRIAW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌯' and DevSIRIAW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevSIRIAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevSIRIAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevSIRIAW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevSIRIAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevSIRIAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevSIRIAW(msg) then 
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/SIRIATEAM) \n⌯︙[قناه السورس](t.me/vvvmh)')
end
if text == "ضع اسم للبوت ⌯" and DevSIRIAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevSIRIAW(msg) then 
...
if text == 'المشتركين ⌯' and DevSIRIAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevSIRIAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevSIRIAW(msg) then
...
if text == ("قائمه العام ⌯") and DevSIRIAW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevSIRIAW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevSIRIAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevSIRIAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevSIRIAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevSIRIAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevSIRIAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevSIRIAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevSIRIAW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevSIRIAW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..SIRIAk..''..SIRIA..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevSIRIAW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevSIRIAW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevSIRIAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevSIRIAW(msg) then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSIRIAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevSIRIAW(msg) then
...
if text and text:match("^تغير رساله الاشتراك$") and DevSIRIAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevSIRIAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevSIRIAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevSIRIAW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevSIRIAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevSIRIAW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
if t2.id_ then 
name_SIRIA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_SIRIA then 
names_SIRIA = database:smembers(bot_id.."SIRIA:blocname"..msg.chat_id_) or ""
if names_SIRIA and names_SIRIA[1] then 
for i=1,#names_SIRIA do 
if name_SIRIA:match("(.*)("..names_SIRIA[i]..")(.*)") then 
...
function amir_SIRIAa_new(SIRIA1,SIRIA2)
if SIRIA2 and SIRIA2.first_name_ then 
if SIRIA2.first_name_:match("(.*)"..database:get(bot_id.."SIRIA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SIRIA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local SIRIA_nnn = database:get(bot_id.."SIRIA:nump"..msg.chat_id_) or 5
local SIRIA_nnn2 = database:get(bot_id.."SIRIA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(SIRIA_nnn2) == tonumber(SIRIA_nnn) or tonumber(SIRIA_nnn2) > tonumber(SIRIA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SIRIA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..SIRIA2.username_.."](https://t.me/"..(SIRIA2.username_ or "vvvmh")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SIRIA:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(SIRIA_nnn) - tonumber(SIRIA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_SIRIAa_new)
end
end
...
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @SIRIATEAM .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ\n\n[⌯  ᴛᴇʟᴀɴᴅ ᴄʜᴀɴɴᴇʟ](http://t.me/SIRIATEAM)\n\n[⌯  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/vvvmh)\n\n[⌯  ᴛᴇʟᴀɴᴅ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/IMMHH)\n\n[⌯  ʙᴏᴛ ᴛᴇʟᴀɴᴅ](http://t.me/Tilllandbot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url="t.me/SIRIATEAM/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SIRIATEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevSIRIAW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevSIRIAW(msg) then
dofile('SIRIA.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevSIRIAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevSIRIAW(msg) then  
function start_function(extra, result, success)
if SIRIASudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevSIRIAW(msg) then  
...
if SIRIASudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevSIRIAW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if SIRIASudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevSIRIAW(msg) then  
function start_function(extra, result, success)
if SIRIASudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevSIRIAW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevSIRIAW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if SIRIASudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevSIRIAW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevSIRIAW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevSIRIAW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevSIRIAW(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevSIRIAW(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevSIRIAW(msg) then
...
if text == "مسح الملفات" and DevSIRIAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevSIRIAW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevSIRIAW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "vvvmh")
...
local TexSIR = {string.match(text, "^(كتم) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexSIR[3] == 'يوم' then
Time_Restrict = TexSIR[2]:match('(%d+)')
Time = Time_Restrict * 86400
end
if TexSIR[3] == 'ساعه' then
Time_Restrict = TexSIR[2]:match('(%d+)')
Time = Time_Restrict * 3600
end
if TexSIR[3] == 'دقيقه' then
Time_Restrict = TexSIR[2]:match('(%d+)')
Time = Time_Restrict * 60
end
TexSIR[3] = TexSIR[3]:gsub('دقيقه',"دقايق") 
TexSIR[3] = TexSIR[3]:gsub('ساعه',"ساعات") 
TexSIR[3] = TexSIR[3]:gsub("يوم","ايام") 
if SIRIASudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = TexSIR[4]}, start_function, nil)
return false
end
...
local TexSIR = {string.match(text, "^(تقيد) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexSIR[3] == 'يوم' then
Time_Restrict = TexSIR[2]:match('(%d+)')
Time = Time_Restrict * 86400
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'vvvmh')..')'
status  = '\n*⌯︙تم تقيده لمدة ~* { '..TexSIR[2]..' '..TexSIR[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
if text == 'مسح كليشه المطور' and DevSIRIAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevSIRIAW(msg) then
...
if text == 'تفعيل الاذاعه' and DevSIRIAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevSIRIAW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..SIRIA_Msg[math.random(#SIRIA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevSIRIAW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,SIRIA)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
x = 0
local list = SIRIA.members_
for k, v in pairs(list) do
x = x + 1
...
if SIRIASudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevSIRIAW(msg) then 
...
if text == ("ردود المطور") and DevSIRIAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝗧𝗘 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevSIRIAW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevSIRIAW(msg) then    
...
if text == 'تفعيل المغادره' and DevSIRIAW(msg) then   
...
if text == 'تعطيل المغادره' and DevSIRIAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SIRIATEAM')..') '
...
if text == 'استعاده الاوامر' and DevSIRIAW(msg) then
...
{{text = '𝑇𝐸𝐿𝐴𝑁𝐷 𝑇𝐸𝐴𝑀', url="t.me/SIRIATEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
zh = https.request('https://vvvzvv.ml/amirZhfa/SIRIA.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*•━━━━━━ 𝗧𝗘 ━━━━━━━•*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/SIRIA.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/SIRIA.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/SIRIA.php')
if res == 200 then
...
{{text = 'sᴏᴜʀᴄʀ ᴛᴇʟᴀɴᴅ',url='http://t.me/SIRIATEAM'}},
}
